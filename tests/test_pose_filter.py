...
def pose(error: float, ambiguity: float = 0.0) -> TagPose:
    return TagPose(
        tag_id=7,
        pose_cam_tag=None,
        reprojection_error_px=error,
        ambiguity_ratio=ambiguity,
        observation=TagObservation(tag_id=7, corners=SQUARE),
    )
