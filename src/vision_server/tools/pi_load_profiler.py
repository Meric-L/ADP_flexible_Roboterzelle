...
def run(args: argparse.Namespace) -> int:
    ...
    if args.csv:
        ...
        csv_writer.writerow(["elapsed_s", "pid", "name", "cpu_percent", "rss_kb"])
    ...
    try:
        while not stop:
            ...
            for sample in samples:
                ...
                if csv_writer:
                    csv_writer.writerow([f"{elapsed:.1f}", sample.pid, sample.name,
    ...
    print("\n=== Zusammenfassung (nach Durchschnitts-CPU%, absteigend) ===")
