        ...
        while True:
            ...
            if age is not None and age > self._config.stale_frame_s:
                ...
                try:
                    ...
                    if encoded is not None and started >= self._next_node_write:
                        # Fester Takt statt "seit dem letzten Schreiben", sonst
                        # sinkt die Rate bei schnellem Tick unter stream_fps.
                        self._next_node_write = max(
                            self._next_node_write + node_interval, started
                        )
